...
| `hiddenstage_bridge/kv_proj_text_delta_300k_from_epoch1_a0p35.pt` | 일반 이미지 생성 및 style tag prompt에 쓰는 v0.1 기본 품질 bridge profile |
...
`kv_proj_text_delta_300k_from_epoch1_a0p35.pt`를 사용합니다. 이전 10k style
bridge는 학습량이 부족해 기본 라우팅에서 제외했습니다. 이 bridge profile들은
